...
@section('content')
    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="grid grid-cols-3 lg:grid-cols-1 gap-5 mt-2">
            <form id="form-create" method="POST" action="{{ route('spatialGroup.store') }}">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
