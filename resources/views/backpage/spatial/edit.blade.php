...
@section('content')
    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="grid grid-cols-3 lg:grid-cols-1 gap-5 mt-2">
            <form id="form-create" method="POST" action="{{ route('spatial.update', $spatial->sp_id) }}">
                @method('PUT')
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select id="group_id"
                                ...
                                @foreach ($spatialGroups as $spatialGroup)
                                    <option value="{{ $spatialGroup->group_id }}"
                                        {{ old('Select Group', $spatial->group_id) == $spatialGroup->group_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name_spatial"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Name" required name="name" value="{{ old('title', $spatial->name) }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="spatial_url"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Wms" name="url" required value="{{ old('title', $spatial->url) }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="spatial_attribute"
                                ...
                                value="{{ old('title', $spatial->attribute) }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea id="" cols="10" rows="3"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Description" name="description">{{ old('title', $spatial->description) }}"</textarea>
                        </div>
