...
@section('content')
    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <form  method = "POST" action="{{ route('spatial.update',$spatial->sp_id) }}" >
            <!-- best seller & traffic -->
            <div id="form-edit"    class="grid grid-cols-2 lg:grid-cols-1 gap-5 mt-2">
                @method('put')
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="spatial_url"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Url" required value="{{ old('title', $spatial->url) }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="spatial_attribute"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Attribute" required value="{{ old('title', $spatial->attribute) }}">
                        </div>
                        <div class="mb-3">
                            <label for="spatial_description"
                                class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Description
                            </label>
                            <textarea name="" id="" cols="10" rows="3"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Description" >{{ $spatial->description }}</textarea>
                        </div>
