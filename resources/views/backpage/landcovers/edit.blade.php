...
@section('content')
    ...
    <div class="bg-gray-100 flex-1 p-6 md:mt-16">
        ...
        <div class="grid grid-cols-3 lg:grid-cols-1 gap-5 mt-2">
            <form id="form-create" method="POST" action="{{ route('landcover.update', $landcovers->lc_id) }}">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div>
                                <select id="type" name="type"
                                    ...
                                    <option value="agriculture" {!! old('type') == 'agriculture' ? 'selected' : '' !!}>Agriculture</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="landcover"
                                ...
                                value="{{ old('landcover', $landcovers->landcover) }}">
                        </div>
                        <div class="mb-3">
                            <label for="icon" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Icon
                            </label>
                            <input type="text" id="icon"
                                class="shadow-sm bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                                placeholder="Name Icon" required name="icon" value="{{ old('icon', $landcovers->icon) }}">
                        </div>
