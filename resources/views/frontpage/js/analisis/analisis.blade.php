                ...
                success: function(response) {
                    ...
                    if (response && response.map) {
                        ...
                        if ($("#" + idCheckBox).is(":checked")) {
                            layerMapFromGEE.addTo(
                                map
                            ); //Display layer VCI automatic to map if checkbox already checked
                        ...
                        $("#" + idCheckBox).on("change", function() {
                            if (this.checked) {
                                layerMapFromGEE.addTo(
                                    map); //Display layer to map if checkbox is checked
                            } else {
                                layerMapFromGEE.removeFrom(
                                    map); //Remove layer in map if not checked
                            }
                        });
                            ...
                            options: {
                                ...
                                scales: {
                                    ...
                                    y: {
                                        ...
                                        min: responseKey === "EVI" ||
                                            responseKey === "MSI" ?
                                            Math.min(...dataArray) - 0.1 : Math.min(...
                                                dataArray) - 10,
                                        max: responseKey === "EVI" ||
                                            responseKey === "MSI" ?
                                            Math.max(...dataArray) + 0.1 : Math.max(...
                                                dataArray) + 50,
                                        beginAtZero: true,
                                    },
                                },
